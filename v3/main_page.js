...
// Function to load the create_tag.html into the iframe or dynamic content area
function loadCreateTagPage() {
    // If you want to load it into a section of the same page:
    loadPage("create_tag.html", "dynamicContent");

    // If you want to load it as a standalone page in the same iframe:
    // window.location.href = 'create_tag.html';
}

// Add an event listener for the "Create New Tag" button
document.getElementById("createTagButton").addEventListener("click", function() {
    loadCreateTagPage();
});